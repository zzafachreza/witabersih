...
export default function MasterBarangEdit({ navigation, route }) {
    const options = {
        includeBase64: true,
        quality: 1,
    };
                ...
                if (response.fileSize <= 2000000) {
                    ...
                    switch (xyz) {
                        case 1:
                            setKirim({
                                ...kirim,
                                newfoto_barang: `data:${response.type};base64, ${response.base64}`,
                            });
                            break;
                    }
                } else {
            ...
            <View style={{
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <TouchableOpacity onPress={() => getGallery(1)} style={{
                        ...
                        {kirim.newfoto_barang !== 'https://zavalabs.com/nogambar.jpg' && <Image source={{
                            uri: kirim.newfoto_barang !== null ? kirim.newfoto_barang : kirim.foto_barang
                        }} style={{
                            width: '110%',
                            height: 250,
                        }} />}
                        {kirim.newfoto_barang == 'https://zavalabs.com/nogambar.jpg' && <Image source={require('../../assets/camera.png')} style={{
                            width: 40,
                            height: 40,
                        }} />}
                    </TouchableOpacity>
