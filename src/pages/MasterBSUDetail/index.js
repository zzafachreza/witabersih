...
export default function MasterBSUDetail({ navigation, route }) {
    ...
    return (
        <SafeAreaView style={{
            ...
            <View style={{
                ...
                <MyList l="Nama BSU" v={item.nama_lengkap} />
            ...
            <View style={{
                ...
                <TouchableOpacity onPress={() => navigation.replace('MasterBSUEdit', item)} style={{
                    flex: 1,
