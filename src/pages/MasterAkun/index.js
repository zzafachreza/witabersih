...
export default function MasterAkun({ navigation }) {
    ...
    const getTransaction = () => {
        axios.post(apiURL + 'akun').then(res => {
            setData(res.data);
            setTmp(res.data);
        ...
        <SafeAreaView style={{
            ...
            <View style={{
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    {data.map(i => {
                        return (
                            <TouchableOpacity onPress={() => navigation.navigate('MasterAkunDetail', i)} style={{
                                borderWidth: 1,
                                marginVertical: 5,
                                padding: 10,
                                borderRadius: 5,
                                ...
                                <View style={{
                                    ...
                                    <Text style={{
                                        color: i.level == 'Admin' ? colors.danger : i.level == 'BSU' ? colors.tertiary : colors.primary,
                                        fontFamily: fonts.secondary[600],
                                        fontSize: 14
                                    }}>{i.level}</Text>
                                    <Text style={{
            ...
            <TouchableOpacity onPress={() => navigation.navigate('MasterAkunAdd')} style={{
                padding: 15,
