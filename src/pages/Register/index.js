...
export default function Register({ navigation }) {
    ...
    const daftar = () => {
        ...
        if (kirim.telepon == null) {
            ...
            axios
                .post(apiURL + 'register_marketplace', kirim)
                .then(res => {
                    setLoading(false);
    ...
    return (
        <>
            <ScrollView style={{ padding: 10, flex: 1, backgroundColor: colors.white, position: 'relative' }}>
                ...
                <MyInput label="Nama Anda" onChangeText={x => setKirim({
                    ...kirim,
                    nama_lengkap: x
                })} />
                <MyGap jarak={10} />
                ...
                <MyInput placeholder="Masukkan 6 Digit Angka Berbeda" label="PIN Anda" maxLength={6} onChangeText={x => setKirim({
                    ...kirim,
                    pin: x
