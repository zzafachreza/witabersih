...
export default function ({ navigation }) {
  ...
  const masuk = () => {
    ...
    if (kirim.telepon == null && kirim.pin.length == 0) {
      ...
      axios
        .post(apiURL + 'login_marketplace', kirim)
        .then(res => {
          setLoading(false);
  ...
  return (
    <>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('LoginAdmin')} style={{
        padding: 10,
      ...
      }}>Tekan Disini, Jika Anda BSU/Admin</Text></TouchableOpacity>
    </>
  );
}
