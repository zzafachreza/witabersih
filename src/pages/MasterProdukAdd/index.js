...
export default function MasterProdukAdd({ navigation, route }) {
    const options = {
        includeBase64: true,
        quality: 1,
    };
            ...
            <View style={{
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <TouchableOpacity onPress={() => getGallery(1)} style={{
                        ...
                        {kirim.foto_produk !== 'https://zavalabs.com/nogambar.jpg' && <Image source={{
                            uri: kirim.foto_produk
                        }} style={{
                            width: '110%',
                            height: 250,
                        }} />}
                        {kirim.foto_produk == 'https://zavalabs.com/nogambar.jpg' && <Image source={require('../../assets/camera.png')} style={{
                            width: 40,
                            height: 40,
                        }} />}
                    </TouchableOpacity>
