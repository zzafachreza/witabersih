...
export default function MasterBSU({ navigation }) {
    ...
    const getTransaction = () => {
        axios.post(apiURL + 'bsu').then(res => {
            setData(res.data);
            setTmp(res.data);
        ...
        <SafeAreaView style={{
            ...
            <View style={{
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    {data.map(i => {
                        return (
                            <TouchableOpacity onPress={() => navigation.navigate('MasterBSUDetail', i)} style={{
                                borderWidth: 1,
                                marginVertical: 5,
                                padding: 10,
                                borderRadius: 5,
            ...
            <TouchableOpacity onPress={() => navigation.navigate('MasterBSUAdd')} style={{
                padding: 15,
